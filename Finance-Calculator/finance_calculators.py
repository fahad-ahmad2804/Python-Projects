...
Note to reviewer:
the Bond calculation does not return the value I am expecting
I attended a mentor call to see if an explanation could be found however the mentor
did not/could not see anything wrong with my code or the formula and suggested submitting
this task as it is
They also informed me that by this stage pseudocode is no longer a requirement which is
why there isn't any on this file
